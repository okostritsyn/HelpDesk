...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	Если ЗавершениеРаботы Тогда 
		ТекстПредупреждения = "Данные по заявке не были сохранены! Изменения могут быть не сохранены!"; 
		Отказ = Истина;
...
Процедура УстановитьВидимость()
	...
	РаботаВВебКлиенте = ТипЗнч(Элементы.ПолеHTMLДокумента.Документ) = Тип("ВнешнийОбъект");
	РаботаВВебКлиенте = Ложь;

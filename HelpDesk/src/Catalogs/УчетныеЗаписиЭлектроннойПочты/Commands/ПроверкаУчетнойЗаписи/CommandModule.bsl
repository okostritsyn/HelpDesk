...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ОбработкаКомандыФрагмент(ДанныеУчетнойЗаписи, ПарольПараметр, УчетнаяЗапись);
КонецПроцедуры
...
&НаКлиенте
Процедура ОбработкаКомандыФрагмент(Знач ДанныеУчетнойЗаписи, Знач ПарольПараметр, Знач УчетнаяЗапись)
